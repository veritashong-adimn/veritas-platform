...
export type DocType = "id_card" | "bankbook" | "business_license";
...
이미지에서 명확하게 식별 가능한 정보만 추출하고, 추측하거나 임의로 생성하지 마세요.
다음 JSON 스키마로만 응답하세요:
{"name": string|null, "businessNumber": string|null, "representativeName": string|null, "registeredAt": string|null, "industry": string|null, "businessCategory": string|null, "address": string|null, "confidence": "high"|"medium"|"low", "notes": string|null}
- name: 상호(법인명 또는 사업장명)
