...
이미지에서 명확하게 식별 가능한 정보만 추출하고, 추측하거나 임의로 생성하지 마세요.
다음 JSON 스키마로만 응답하세요:
{"contactName": string|null, "companyName": string|null, "department": string|null, "position": string|null, "email": string|null, "mobilePhone": string|null, "officePhone": string|null, "memo": string|null, "confidence": "high"|"medium"|"low", "notes": string|null}
- contactName: 담당자 이름 (한글 또는 영문)
- companyName: 회사명/브랜드명 (명함에 표시된 그대로)
- department: 부서명 (팀, 본부, 사업부 포함)
- position: 직책/직위 (예: 과장, Manager, 팀장, 대리)
- email: 이메일 주소
- mobilePhone: 휴대폰 번호 (숫자만. 예: "01012345678"). Cell, Mobile, HP 등 표시 우선
- officePhone: 직장 전화번호 (숫자만. 예: "0212345678"). Tel, 대표번호, 직통번호 포함
