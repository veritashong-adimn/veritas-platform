          ...
          <a href="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
            <div style={{
              ...
              <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                <defs>
                  <linearGradient id="vg_id" x1="2" y1="4" x2="30" y2="29" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#6366f1"/>
                    <stop offset="100%" stopColor="#22d3ee"/>
                  </linearGradient>
                </defs>
                <path fillRule="evenodd" d="M2,4 L30,4 L16,29 Z M10,4 L22,4 L16,24 Z" fill="url(#vg_id)"/>
              </svg>
            </div>
