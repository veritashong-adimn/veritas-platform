...
export const AdminListProjectsResponseItem = zod.object({
  ...
  projectCustomerId: zod.number().nullable(),
  ...
  financialStatus: zod.string().nullish(),
  divisionName: zod.string().nullish(),
  billingCompanyName: zod.string().nullish(),
  payerCompanyName: zod.string().nullish(),
  requestingCompanyName: zod.string().nullish(),
  requestingCompanyId: zod.number().nullish(),
  requestingDivisionId: zod.number().nullish(),
  billingCompanyId: zod.number().nullish(),
  payerCompanyId: zod.number().nullish(),
  hasQuote: zod.boolean().optional(),
  hasPaid: zod.boolean().optional(),
  taskCount: zod.number().optional(),
  quotePrice: zod.union([zod.string(), zod.number()]).nullish(),
  quoteStatus: zod.string().nullish(),
  quoteType: zod.string().nullish(),
 ...
 */
export const AdminListTasksResponseItem = zod.object({
  id: zod.number(),
  projectId: zod.number(),
  translatorId: zod.number(),
  status: zod.string(),
  ...
  projectTitle: zod.string().nullable(),
  projectStatus: zod.string().nullable(),
  translatorEmail: zod.string().nullable(),
});
